...
""")
        ...
        print()
        response = model.generate_content(f"""
Haja como um profissional de nutrição. Seu trabalho é mostrar a informação nutricional de um alimento chamado {alimento}.
...
""")
        ...
        break
print()
print(f'{nome},Obrigado por utilizar o Thrive !   Volte Sempre.')
print()
